...
> **Turn PDF highlights into study questions inside Notion — powered by local AI**
...
[![GitHub Stars](https://img.shields.io/github/stars/tusharkrbarman/learnbetter?style=social)](https://github.com/tusharkrbarman/learnbetter/stargazers)
[![GitHub Forks](https://img.shields.io/github/forks/tusharkrbarman/learnbetter?style=social)](https://github.com/tusharkrbarman/learnbetter/network/members)
[![GitHub Issues](https://img.shields.io/github/issues/tusharkrbarman/learnbetter)](https://github.com/tusharkrbarman/learnbetter/issues)
[![PRs Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg)](https://github.com/tusharkrbarman/learnbetter/pulls)
[![Contributors](https://img.shields.io/github/contributors/tusharkrbarman/learnbetter)](https://github.com/tusharkrbarman/learnbetter/graphs/contributors)
...
- [Using LearnBetter](#-using-learnbetter)
- [Offline And Retry Behavior](#-offline-and-retry-behavior)
- [Removing Captures](#-removing-captures)
...
- [Community](#-community)
- [Changelog](#-changelog)
- [Official Setup References](#-official-setup-references)
- [License](#-license)
...
> 📹 **Demo video coming soon** — contributions welcome!
...
Please read our [Contributing Guidelines](CONTRIBUTING.md) for more details on our code of conduct, pull request process, and development workflow.

## 👥 Community

- 💬 [GitHub Discussions](https://github.com/tusharkrbarman/learnbetter/discussions) - Ask questions, share ideas
- 🐛 [Issue Tracker](https://github.com/tusharkrbarman/learnbetter/issues) - Report bugs, request features
- 📧 [Email](mailto:tusharkrbarman@gmail.com) - Direct contact

## 📜 Changelog

See [Releases](https://github.com/tusharkrbarman/learnbetter/releases) for version history and release notes.
